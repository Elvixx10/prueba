...
return array(
    ...
    "'%value%' is not a valid email address in the basic format local-part@hostname"=>"'%value%' No es una dirección de correo válida",
...
// Zend_Validate_GreaterThan
    ...
    "'%value%' is not a valid hostname for email address" => "'%value%' Dirección de correo inválida",
